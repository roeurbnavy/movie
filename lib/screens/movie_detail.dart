...
class MovieDetailScreen extends StatelessWidget {
  ...
  List<Widget> _buildBackground(BuildContext context, MovieDetail movie) {
    return [
      ClipPath(
        child: ClipRRect(
      ...
      GestureDetector(
        onTap: () async {
          final youtubeUrl =
              Uri.parse('https://www.youtube.com/embed/${movie.trailerId}');
          if (!await launchUrl(
            youtubeUrl,
  ...
  Padding _buildDes(BuildContext context) {
    return Padding(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: Theme.of(context)
                .textTheme
                .caption!
                .copyWith(fontWeight: FontWeight.bold, fontFamily: 'muli'),
          ),
          SizedBox(
            height: 155,
            child: ListView.separated(
              itemCount: movie.movieImage!.backdrops.length,
              separatorBuilder: (__, index) => const VerticalDivider(
                color: Colors.transparent,
                width: 5,
              ),
              scrollDirection: Axis.horizontal,
              itemBuilder: (__, index) {
                ScreenShort image = movie.movieImage!.backdrops[index];
                return Card(
                  elevation: 3,
